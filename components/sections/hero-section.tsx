...
const phrases = [
  "Votre séjour à l’Hermitage, en groupe, en famille",
  "au cœur d'un des plus grand tiers lieu rural en Picardie",
  "chargé d'une histoire sociale et solidaire centenaire,",
  "dans un ancien domaine de chasse rural centenaire,",  
  "un bois de 22ha, accessible à toutes et tous,",
  "des chalets historiques, au coeur du bois,",
  "un campement de tipis en période estivale,",
  "deux maisons forestières, dans la nature,",
  "une maison d'hôtes dans un ancien manoir,",
  "pour déconnecter,",
  "reconnecter,",
  "au vivant,",
  "au collectif",
  "un Fablab, une menuiserie, un atelier partagé,",
  "de magnifiques espaces de travail",
  "pour construire de belles dynamiques collectives,",
  "construire autrement, travailler librement,",
  "faire commun, partager des moments simples",
  "à très vite !!",
];
...
const MOBILE_LETTER_DELAY_S = 0.03;
const MOBILE_LETTER_ANIM_S = 0.4;
